...
class SwaggyDataService {
    ...
    ControllerDefinition apiDetails(String controllerName) {
       ...
       // def absoluteBasePath = grailsLinkGenerator.link(uri: '', absolute: true)
        def absoluteBasePath = "https://localhost:8443/apiman-gateway/digicamere/test-api3/1.0"
        ...
        println "absoluteBasePath: ${absoluteBasePath} - basePath: ${basePath} - resourcePath: ${resourcePath}"
